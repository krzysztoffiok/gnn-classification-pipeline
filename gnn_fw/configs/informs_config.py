...
class Config:
    ...
    def __init__(self, gnn_model_name: str = "GCN", hidden_channels: int = 16, threshold: float = -2,
        ...
        self.selected_dataset = "hcp_17_51"  #"hcp_rs_606"
        ...
        self.hidden_channel_list = [32, 64, 112, 256]   # best result was obtained with 3072.
        ...
        # pass ["False"]
        self.node_embedding_method_list = ["False", "DeepWalk", "Node2Vec", "NodeSketch", "Feather"]
        ...
        self.training_parameters = {"number_of_classes": self.number_of_classes,
                                    ...
                                    "lr": 0.0001,     # for mutag: 1e-2, for hcp_17_51 1e-4
                                    "epochs": 1200,
                                    "min_lr": 0.00001,     # for mutag: 1e-4, for hcp_17_51 1e-6
                                    "patience": 25,
                                    "threshold": 1e-5,
